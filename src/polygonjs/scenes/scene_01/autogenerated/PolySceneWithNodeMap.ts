...
export interface PolySceneProps_scene_01 {
	...
	'fxhash-roundedBox1--size'?: ParamValueSerializedTypeMap['vector3'];
	'fxhash-roundedBox1--size-sizex'?: ParamValueSerializedTypeMap['float'];
	'fxhash-roundedBox1--size-sizey'?: ParamValueSerializedTypeMap['float'];
	'fxhash-roundedBox1--size-sizez'?: ParamValueSerializedTypeMap['float'];
	'fxhash-roundedBox1--sizex'?: ParamValueSerializedTypeMap['float'];
	'fxhash-roundedBox1--sizey'?: ParamValueSerializedTypeMap['float'];
	'fxhash-roundedBox1--sizez'?: ParamValueSerializedTypeMap['float'];
